        ...
        try {
            ...
            if (
                ...
                if (!aboutMeneg.login || !aboutMeneg.password) {
                    ...
                    return res
                        .status(401)
                        .send("Некорректный login или password");
                }
                ...
                try {
                    ...
                    return res
                        .status(500)
                        .send(
                            "Ошибка заполнения идентификационных или личных данных"
                        );
                }
            }
                    ...
                    include: [
                        {
                            ...
                            include: {
                                model: Account_Data,
                                attributes: {
                                    exclude: ["id_account_data", "password"],
                                },
                            },
                        },
                    ],
                ...
                departmentF.users.map((user, index) => {
                    ...
                    do {
                        ...
                        async function get1() {
                            ...
                            if (!firstDateCurrentYear || !lastDateCurrentYear)
                                return;
