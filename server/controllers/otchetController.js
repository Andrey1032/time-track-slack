...
// const { Department, Reworking, Calendar, Underworking, Reworking_month, Underworking_month, Writing_off_time} = require("../database/models");
    ...
    try {
      ...
      if (Array.isArray(departmentF)) {
        ...
        departmentForOtchet = {
          ...
          subtitle: `Табель рабочего времени ${months[month - 1]} ${year} г. ${
            departmentF.title
          }`,
          underworking: [],
          reworking: [],
        ...
        departmentF.users.forEach(async (user) => {
          let massivDatesRework = new Array(lastDayCurrentMonth.getDate()).fill(
            null
          );
          let massivDatesUnderwork = new Array(
            lastDayCurrentMonth.getDate()
